...
public interface LockingAndVersioningRepository<T> {
    ...
    /**
     * Creates and returns a new version of the entity as a private working copy. The given entity remains the
     * latest version.
     * <p/>
     * This method requires the entity class to have a copy constructor that will be used to clone the entity
     * in order to create the new working copy.
     *
     * @param <S>    the type of entity
    ...
    /**
     * Creates and returns a new version of the entity. This new version becomes the latest version in the
     * version list.
     * <p/>
     * If the supplied entity is a private working copy, it will be promoted from a working copy to the new
     * version.
     * <p/>
     * If the supplied entity is not a private working copy, the entity will be cloned in order to create the
     * new version. This requires the entity class to have a copy constructor that is used for the cloning
     * process.
     *
     * @param <S>    the type of entity
     * @param entity the entity to base the new versionWithEntity on
