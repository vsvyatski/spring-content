...
public class SpringBootContentRestConfigurerTest {
    ...
    {
        Describe("SpringBootContentRestConfigurer", () -> Context("#configure", () -> {
            ...
            Context("given a base uri property", () -> {
                ...
                BeforeEach(() -> properties.setBaseUri(URI.create("/test")));
            ...
            Context("given a fullyQualifiedLinks property setting", () -> {
                ...
                BeforeEach(() -> properties.setFullyQualifiedLinks(true));
            ...
            Context("given disabled shortcut request mappings", () -> {
                ...
                It("should disable the shortcut links", () -> verify(restConfig).setShortcutLinks(false));
            });
