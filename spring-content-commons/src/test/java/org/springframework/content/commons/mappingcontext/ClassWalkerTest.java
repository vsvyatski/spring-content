...
public class ClassWalkerTest {
    ...
    {
        Describe("ClassWalker", () -> It("should visit all fields", () -> {
        ...
        Context("given a class with uncorrelated attributes", () -> It("should return two content properties", () -> {
            ContentPropertyMappingContextVisitor visitor = new ContentPropertyMappingContextVisitor("/", ".");
            ClassWalker walker = new ClassWalker(visitor);
        ...
        Context("given a class with correlated attributes", () -> It("should return two content properties", () -> {
            ContentPropertyMappingContextVisitor visitor = new ContentPropertyMappingContextVisitor("/", ".");
            ClassWalker walker = new ClassWalker(visitor);
        ...
        Context("given a class with a child with uncorrelated attributes", () -> It("should return two content properties", () -> {
            ContentPropertyMappingContextVisitor visitor = new ContentPropertyMappingContextVisitor("/", ".");
            ClassWalker walker = new ClassWalker(visitor);
        ...
        Context("given a class with relation attributes", () -> It("should not traverse them", () -> {
            ContentPropertyMappingContextVisitor visitor = new ContentPropertyMappingContextVisitor("/", ".");
            ClassWalker walker = new ClassWalker(visitor);
        ...
        Context("given a class with content properties in its super class", () -> It("should visit them", () -> {
            ContentPropertyMappingContextVisitor visitor = new ContentPropertyMappingContextVisitor("/", ".");
            ClassWalker walker = new ClassWalker(visitor);
        ...
        Context("given a class with multiple child content property objects", () -> It("should return two content properties", () -> {
            ContentPropertyMappingContextVisitor visitor = new ContentPropertyMappingContextVisitor("/", ".");
            ClassWalker walker = new ClassWalker(visitor);
