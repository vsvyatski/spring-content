        ...
        Describe("BeanUtils", () -> {
            Context("#setFieldWithAnnotation", () -> {
                Context("given a simple, non-inheriting class", () -> {
                    BeforeEach(() -> testEntity = new TestEntity());
                ...
                Context("given an inheriting class", () -> {
                    BeforeEach(() -> testEntity = new InheritingTestEntity());
                    It("should set field directly", () -> {
            ...
            Context("#hasFieldWithAnnotation", () -> {
                Context("given a simple, non-inheriting class", () -> {
                    BeforeEach(() -> testEntity = new TestEntity());
                    It("should return true for annotated public fields", () -> assertThat(
                            BeanUtils.hasFieldWithAnnotation(testEntity, ContentId.class), is(true)
                    ));
                    It("should return true for annotated private fields with getter", () -> assertThat(
                            BeanUtils.hasFieldWithAnnotation(testEntity, ContentLength.class), is(true)
                    ));
            ...
            Context("#getFieldWithAnnotationType", () -> {
                Context("given a simple, non-inheriting class", () -> {
                    BeforeEach(() -> testEntity = new TestEntity());
                    It("should return true for annotated public fields", () -> assertThat(
                            BeanUtils.getFieldWithAnnotationType(testEntity, ContentId.class),
                            is(CoreMatchers.equalTo(String.class))
                    ));
                    It("should return true for annotated private fields with getter", () -> assertThat(
                            BeanUtils.getFieldWithAnnotationType(testEntity, ContentLength.class),
                            is(CoreMatchers.equalTo(String.class))
                    ));
            ...
            Context("#findFieldWithAnnotation", () -> {
                Context("given a simple, non-inheriting class", () -> {
                    BeforeEach(() -> testEntity = new TestEntity());
                    It("should find fields", () -> assertThat(
                            BeanUtils.findFieldWithAnnotation(testEntity, ContentId.class), is(not(nullValue()))
                    ));
                    It("should find fields with getters", () -> assertThat(
                            BeanUtils.findFieldWithAnnotation(testEntity,
            ...
            Context("#findFieldsWithAnnotation", () -> It("should find fields", () -> assertThat(
                    BeanUtils.findFieldsWithAnnotation(TestEntity2.class, MimeType.class, new BeanWrapperImpl(new TestEntity2())).length, is(1)
            )));

            Context("#getFieldsWithAnnotation", () -> It("should find fields", () -> {
